...
export default function IndustryDetailsPage({
    ...
    useEffect(() => {
        getIndustryById(params.id);
    }, [params.id, getIndustryById]);
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                        View industry information and details.
                    </p>
                </div>
                <Button
                    onClick={() =>
                        router.push(`/settings/industries/${params.id}/edit`)
                    }
                >
                    Edit Industry
                </Button>
                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p>{formatDate(industry.createAt)}</p>
                        </div>
                    </div>
                </CardContent>
            </Card>
